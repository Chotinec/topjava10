                ...
                <table class="table table-striped display" id="datatable">
                    ...
                    <c:forEach items="${users}" var="user">
                        ...
                        <tr id="${user.id}">
                            ...
                            <td>${user.roles}</td>
                            <td>
                                <input type="checkbox" id="enabled_${user.id}" <c:if test="${user.enabled}">checked</c:if> onclick="enableUser(${user.id})"/>
                            </td>
                            <td><fmt:formatDate value="${user.registered}" pattern="dd-MMMM-yyyy"/></td>
                            <td><a class="btn btn-xs btn-primary update"  onclick="updateUser()">
