...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="webjars/datetimepicker/2.3.4/jquery.datetimepicker.css"/>
    ...
    <script defer type="text/javascript" src="webjars/datetimepicker/2.3.4/jquery.datetimepicker.js"></script>
</head>
